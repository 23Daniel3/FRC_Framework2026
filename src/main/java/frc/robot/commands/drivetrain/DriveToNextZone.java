...
public class DriveToNextZone extends Command {
  ...
  public DriveToNextZone(
    ...
    this.fsm = new StateMachine<>("DriveToNext", State.class, State.CALCULATE);
  ...
  private void calculateTargets() {
    ...
    boolean inBlue = Zones.ALLIANCE_BLUE_ZONE.contains(robotPose.getTranslation());
    boolean inRed = Zones.ALLIANCE_RED_ZONE.contains(robotPose.getTranslation());

    if (isBlue) {
      if (inBlue) setupPath(Alliance.Blue);
