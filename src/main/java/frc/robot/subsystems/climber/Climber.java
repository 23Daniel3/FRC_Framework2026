...
public class Climber extends StateSubsystem<ClimberRequest, ClimberState, ClimberIOInputsAutoLogged> {
  
  private final ClimberIO io;

  public Climber(ClimberIO io) {
    super("Subsystems/Climber", new ClimberIOInputsAutoLogged(), ClimberState.class, ClimberState.RETRACTED, ClimberRequest.LOW);
    this.io = io;
    ...
    fsm.addGlobalTransition(
      ...
      () -> currentRequest == ClimberRequest.HIGH && getState() != ClimberState.EXTENDING && getState() != ClimberState.EXTENDED);
    
    fsm.addGlobalTransition(ClimberState.RETRACTING, () -> 
        currentRequest == ClimberRequest.LOW && 
        getState() != ClimberState.RETRACTING && 
