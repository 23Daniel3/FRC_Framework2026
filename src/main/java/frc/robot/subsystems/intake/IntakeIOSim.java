...
public class IntakeIOSim implements IntakeIO {
  ...
  public IntakeIOSim() {
    /**
     * Simulação do Motor do Rolo (Roller)
     * - Motor: Kraken X60 (ou o que estiver usando)
     * - Redução: 2:1 (exemplo)
     * - Inércia: 0.001 (muito leve, apenas um rolo)
     */
    rollerMotor = new MotorIOSim(
        "Intake/Roller",
    ...
    /**
     * Simulação do Motor do Pivot (Intake)
     * - Motor: Neo Vortex / SparkFlex
     * - Redução: 50:1 (Pivot costuma ter redução alta)
     * - Inércia: 0.02 (Carga moderada para simular o peso do braço)
     */
    intakeMotor = new MotorIOSim(
        "Intake/Pivot",
  ...
  /**
   * Método utilitário para testes: permite que você force o estado do sensor 
   * durante a simulação para ver como a sua FSM reage.
   */
