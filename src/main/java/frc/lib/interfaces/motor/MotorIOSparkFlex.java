...
public class MotorIOSparkFlex extends MotorBase {
    ...
    public MotorIOSparkFlex(String name, int id, MotorType type, MotorConfig config, boolean tuningMode) {
        ...
        switch (config.feedbackType) {
            case ALTERNATE -> {
                motorConfig.externalEncoder.countsPerRevolution(config.countsPerRevolution)
